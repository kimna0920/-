...
try{
	...
	String sql = "select * from tbl_player_20221205 WHERE player_id=?";
...
%>
	<h2>등록된 선수 정보 수정</h2>
	<form action="m-action.jsp" method="get" name="frm">
		<table border="1">
			<tr>
				<td>선수ID</td>
				<td><input type="text" name="player_id" value=<%=pid %>></td>
			</tr>
			<tr>
				<td>선수이름</td>
			...
			<tr>
				<td>선수등록일</td>
				<td><input type="text" value="<%=rs.getString(4) %>" name="player_date"></td>
			</tr>
			<tr>
				<td>선수소속팀</td>
				<td>
